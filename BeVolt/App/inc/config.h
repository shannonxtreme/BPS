...
#define MAX_CURRENT_LIMIT				100000		// Max current limit (Amperes)		(Max continuous discharge is 15A per cell)
#define MAX_HIGH_PRECISION_CURRENT 		50000		// Max current detectable by the high-precision current sensor
